...
export const Hero = () => {
  ...
  return (
    <section className="relative container mx-auto py-6 md:py-16 px-2 md:px-4 flex items-center justify-center min-h-[60vh] md:min-h-[80vh]">
      <div 
        className="absolute inset-0 rounded-xl z-0 bg-cover bg-center opacity-80 md:opacity-100" 
        style={{ 
      ...
      />
      <div className="text-center max-w-full md:max-w-3xl relative z-10 py-4 md:py-6 px-2 md:px-0">
        <div className="inline-flex items-center px-2 md:px-4 py-1 md:py-1.5 rounded-full border border-purple-200 bg-purple-50 mb-2">
        ...
        <p className="max-w-full md:max-w-2xl mx-auto mb-3 text-sm md:text-lg text-gray-600 sm:text-md lg:text-xl px-2">
